...
main(int argc, char *argv[])
{
  ...
  19:	e8 bc 03 00 00       	call   3da <mkdir>
    mkdir("mohanya");
  1e:	c7 04 24 40 08 00 00 	movl   $0x840,(%esp)
  25:	e8 b0 03 00 00       	call   3da <mkdir>
    fd = open("/utkarsh/1.txt", O_CREATE|O_RDWR);
  2a:	58                   	pop    %eax
  2b:	5a                   	pop    %edx
  2c:	68 02 02 00 00       	push   $0x202
  31:	68 48 08 00 00       	push   $0x848
  36:	e8 77 03 00 00       	call   3b2 <open>
    fd1 = open("/utkarsh/2.txt", O_CREATE|O_RDWR);
  3b:	59                   	pop    %ecx
  3c:	5b                   	pop    %ebx
  3d:	68 02 02 00 00       	push   $0x202
  42:	68 57 08 00 00       	push   $0x857
    c = 'a';
    write(fd, &c, 1);
  47:	8d 5d e7             	lea    -0x19(%ebp),%ebx
    fd = open("/utkarsh/1.txt", O_CREATE|O_RDWR);
  4a:	89 c7                	mov    %eax,%edi
    fd1 = open("/utkarsh/2.txt", O_CREATE|O_RDWR);
  4c:	e8 61 03 00 00       	call   3b2 <open>
    write(fd, &c, 1);
  ...
  5c:	53                   	push   %ebx
  5d:	57                   	push   %edi
  5e:	e8 2f 03 00 00       	call   392 <write>
    write(fd1, &c, 1);
  63:	83 c4 0c             	add    $0xc,%esp
  66:	6a 01                	push   $0x1
  68:	53                   	push   %ebx
  69:	56                   	push   %esi
  6a:	e8 23 03 00 00       	call   392 <write>
    c = 'a';
    write(fd, &c, 1);
  6f:	83 c4 0c             	add    $0xc,%esp
    c = 'a';
  72:	c6 45 e7 61          	movb   $0x61,-0x19(%ebp)
    write(fd, &c, 1);
  76:	6a 01                	push   $0x1
  78:	53                   	push   %ebx
  79:	57                   	push   %edi
  7a:	e8 13 03 00 00       	call   392 <write>
    write(fd1, &c, 1);
  7f:	83 c4 0c             	add    $0xc,%esp
  82:	6a 01                	push   $0x1
  84:	53                   	push   %ebx
  85:	56                   	push   %esi
  86:	e8 07 03 00 00       	call   392 <write>
    c = 'a';
    write(fd, &c, 1);
  8b:	83 c4 0c             	add    $0xc,%esp
    c = 'a';
  8e:	c6 45 e7 61          	movb   $0x61,-0x19(%ebp)
    write(fd, &c, 1);
  92:	6a 01                	push   $0x1
  94:	53                   	push   %ebx
  95:	57                   	push   %edi
  96:	e8 f7 02 00 00       	call   392 <write>
    write(fd1, &c, 1);
  9b:	83 c4 0c             	add    $0xc,%esp
  9e:	6a 01                	push   $0x1
  a0:	53                   	push   %ebx
  a1:	56                   	push   %esi
  a2:	e8 eb 02 00 00       	call   392 <write>
    c = 'a';
    write(fd, &c, 1);
  a7:	83 c4 0c             	add    $0xc,%esp
    c = 'a';
  aa:	c6 45 e7 61          	movb   $0x61,-0x19(%ebp)
    write(fd, &c, 1);
  ae:	6a 01                	push   $0x1
  b0:	53                   	push   %ebx
  b1:	57                   	push   %edi
  b2:	e8 db 02 00 00       	call   392 <write>
    write(fd1, &c, 1);
  b7:	83 c4 0c             	add    $0xc,%esp
  ba:	6a 01                	push   $0x1
  bc:	53                   	push   %ebx
  bd:	56                   	push   %esi
  be:	e8 cf 02 00 00       	call   392 <write>
    c = 'a';
    write(fd, &c, 1);
  c3:	83 c4 0c             	add    $0xc,%esp
    c = 'a';
  c6:	c6 45 e7 61          	movb   $0x61,-0x19(%ebp)
    write(fd, &c, 1);
  ca:	6a 01                	push   $0x1
  cc:	53                   	push   %ebx
  cd:	57                   	push   %edi
  ce:	e8 bf 02 00 00       	call   392 <write>
    write(fd1, &c, 1);
  d3:	83 c4 0c             	add    $0xc,%esp
  d6:	6a 01                	push   $0x1
  d8:	53                   	push   %ebx
  d9:	56                   	push   %esi
  da:	e8 b3 02 00 00       	call   392 <write>
    c = '\n';
    write(fd, &c, 1);
  df:	83 c4 0c             	add    $0xc,%esp
    c = '\n';
  e2:	c6 45 e7 0a          	movb   $0xa,-0x19(%ebp)
    write(fd, &c, 1);
  e6:	6a 01                	push   $0x1
  e8:	53                   	push   %ebx
  e9:	57                   	push   %edi
  ea:	e8 a3 02 00 00       	call   392 <write>
    write(fd1, &c, 1);
  ef:	83 c4 0c             	add    $0xc,%esp
  f2:	6a 01                	push   $0x1
  f4:	53                   	push   %ebx
  f5:	56                   	push   %esi
  f6:	e8 97 02 00 00       	call   392 <write>
    close(fd);
  fb:	89 3c 24             	mov    %edi,(%esp)
  fe:	e8 97 02 00 00       	call   39a <close>
    close(fd1);
 103:	89 34 24             	mov    %esi,(%esp)
 106:	e8 8f 02 00 00       	call   39a <close>
}
 10b:	31 c0                	xor    %eax,%eax
 10d:	8d 65 f0             	lea    -0x10(%ebp),%esp
 110:	59                   	pop    %ecx
 111:	5b                   	pop    %ebx
 112:	5e                   	pop    %esi
 113:	5f                   	pop    %edi
 114:	5d                   	pop    %ebp
 115:	8d 61 fc             	lea    -0x4(%ecx),%esp
 118:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 66 08 00 00       	mov    $0x866,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 34 0b 00 00       	mov    0xb34,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 34 0b 00 00       	mov    %eax,0xb34
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
 ...
 706:	72 ce                	jb     6d6 <free+0x26>
{
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 72a:	a3 34 0b 00 00       	mov    %eax,0xb34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 34 0b 00 00    	mov    0xb34,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7e7:	89 15 34 0b 00 00    	mov    %edx,0xb34
}
 ...
 7f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 34 0b 00 00 38 	movl   $0xb38,0xb34
 807:	0b 00 00 
 80a:	c7 05 38 0b 00 00 38 	movl   $0xb38,0xb38
 811:	0b 00 00 
    base.s.size = 0;
 814:	b8 38 0b 00 00       	mov    $0xb38,%eax
 819:	c7 05 3c 0b 00 00 00 	movl   $0x0,0xb3c
 820:	00 00 00 
